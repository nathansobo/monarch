...
describe("Record", function() {
  ...
  describe("instance methods", function() {
    ...
    describe("#save()", function() {
      it("sends the dirty fields to the server, then updates the record with the response and triggers success on the promise", function() {
        var post = BlogPost.remotelyCreated({id: 1, blogId: 1, title: 'Title', body: 'Body'});
