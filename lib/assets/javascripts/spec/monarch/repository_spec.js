describe("Monarch.Repository", function() {
  ...
  describe("#clear", function() {
    it("removes all records from all tables without firing callbacks", function() {
    ...
    it("cancels all subscriptions", function() {
      var insertCallback = jasmine.createSpy("insertCallback");
