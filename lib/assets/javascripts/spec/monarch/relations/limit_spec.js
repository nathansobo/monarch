  ...
  describe("events", function() {
    ...
    describe("insert events", function() {
      ...
      it("triggers insert events if tuples are updated in the operand to have and index falling under the count", function() {
        var post1 = BlogPost.created({id: 1, title: "Alpha"});
        var post2 = BlogPost.created({id: 2, title: "Charlie"});
        var post3 = BlogPost.created({id: 3, title: "Echo"});
        insertCallback.reset();
    ...
    describe("the #limit(limitCount, offsetCount) method", function() {
      it("builds limits / offsets", function() {
