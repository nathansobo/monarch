...
describe("Monarch.Relations.InnerJoin", function() {
  ...
  describe("events", function() {
    ...
    describe("update events", function() {
      it("triggers update events when tuples in either operand are updated", function() {
        ...
        var expectedChangeset = {
          title: { oldValue: "Bravo", newValue: "0 Alpha" }
        };
    ...
    describe("remove events", function() {
      it("triggers remove events if a tuple is removed from an operand or updated to no longer match a predicate", function() {
        var blog1 = Blog.remotelyCreated({id: 1, userId: 1, title: "Alpha"});
        var post1 = BlogPost.remotelyCreated({id: 1, blogId: 1, title: "Alpha"});
        var post2 = BlogPost.remotelyCreated({id: 2, blogId: 1, title: "Bravo"});
        var post3 = BlogPost.remotelyCreated({id: 3, blogId: 1, title: "Bravo"});
        var post4 = BlogPost.remotelyCreated({id: 4, blogId: 2, title: "Charlie"});
