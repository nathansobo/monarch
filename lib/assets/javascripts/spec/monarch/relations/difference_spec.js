  ...
  describe("events", function() {
    ...
    describe("update events", function() {
      it("triggers update events when a record in the left operand that is not in the right is updated", function() {
        var post1 = BlogPost.remotelyCreated({id: 1, blogId: 1, title: "Alpha", public: false});
        var post2 = BlogPost.remotelyCreated({id: 2, blogId: 1, title: "Bravo", public: false});
        var post3 = BlogPost.remotelyCreated({id: 3, blogId: 1, title: "Charlie", public: true});
    ...
    describe("remove events", function() {
      ...
      beforeEach(function() {
        post1 = BlogPost.remotelyCreated({id: 1, blogId: 1, title: "Alpha", public: false});
        post2 = BlogPost.remotelyCreated({id: 2, blogId: 1, title: "Bravo", public: false});
        post3 = BlogPost.remotelyCreated({id: 3, blogId: 1, title: "Charlie", public: false});
        post4 = BlogPost.remotelyCreated({id: 4, blogId: 1, title: "Delta", public: true});
      });
      ...
      it("triggers remove events if a tuple is removed from the left operand", function() {
        ...
        post4.remotelyUpdated({blogId: 100});
      ...
      it("triggers remove events if a tuple in the left operand is inserted into the right", function() {
        post2.remotelyUpdated({public: true});
        expect(removeCallback).toHaveBeenCalled();
