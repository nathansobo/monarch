(function(Monarch) {
  Monarch.Relations.Selection = new JS.Class('Monarch.Relations.Selection', Monarch.Relations.Relation, {
    ...
    create: function(attributes) {
      return this.operand.create(_.extend({}, attributes, this.predicate.satisfyingAttributes()));
    },

    created: function(attributes) {
      return this.operand.created(_.extend({}, attributes, this.predicate.satisfyingAttributes()));
    },
